...
export function UserVehicleUserListDoc(): MethodDecorator {
...
export function UserVehicleUserCreateDoc(): MethodDecorator {
  return applyDecorators(
    Doc({
...
export function UserVehicleUserUpdateDoc(): MethodDecorator {
  return applyDecorators(
    Doc({
...
export function UserVehicleUserDeleteDoc(): MethodDecorator {
  return applyDecorators(
    Doc({
...
export function UserVehicleUserParamsIdDoc(): MethodDecorator {
  return applyDecorators(
    Doc({
...
export function UserVehicleUserGetDoc(): MethodDecorator {
  return applyDecorators(
    Doc({
