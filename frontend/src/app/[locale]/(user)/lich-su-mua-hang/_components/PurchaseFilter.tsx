...
export default function PurchaseFilter({
    ...
    shipDateFrom, setShipDateFrom,
    shipDateTo, setShipDateTo,
    setPage
}: Props) {
            ...
            <div className="bg-white rounded-xl shadow flex flex-col gap-4 p-4 mb-6 border border-gray-200">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="flex flex-col gap-2 w-full">
                        <label className="text-base font-medium text-gray-700">Trạng thái</label>
                        <Select
                            value={statusFilter}
                    ...
                    {/* Ngày đặt */}
                    <div className="flex flex-col gap-2 w-full">
                        <label className="text-base font-medium text-gray-700">Ngày đặt</label>
                        {isMobile ? (
                            ...
                            <RangePicker
                                value={
                                    orderDateFrom && orderDateTo
                                        ...
                                        : [orderDateFrom ? dayjs(orderDateFrom) : null, orderDateTo ? dayjs(orderDateTo) : null]
                                }
                                onChange={dates => {
                    ...
                    {/* Ngày giao */}
                    <div className="flex flex-col gap-2 w-full">
                        <label className="text-base font-medium text-gray-700">Ngày giao</label>
                        {isMobile ? (
                            <div className="flex gap-2">
                                <DatePicker
                            ...
                            <RangePicker
                                value={
                                    shipDateFrom && shipDateTo
                                        ...
                                        : [shipDateFrom ? dayjs(shipDateFrom) : null, shipDateTo ? dayjs(shipDateTo) : null]
                                }
                                onChange={dates => {
