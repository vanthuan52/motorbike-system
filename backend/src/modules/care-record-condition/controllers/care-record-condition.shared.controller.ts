...
import {
  CareRecordConditionSharedCreateDoc,
  CareRecordConditionSharedDeleteDoc,
  CareRecordConditionSharedParamsIdDoc,
  CareRecordConditionSharedUpdateDoc,
} from '../docs/care-record-condition.shared.doc';
...
@ApiTags('modules.shared.care-record-condition')
@Controller({
  version: '1',
  path: '/care-record-condition',
})
export class CareRecordConditionSharedController {
  private readonly logger = new Logger(
    CareRecordConditionSharedController.name,
  );
  constructor(
