...
export default function FilterSidebar({
  ...
  const t = useTranslations("productListPage.filterSidebar");
  ...
  return (
    <div className="space-y-6 p-2 md:p-0">
      <div>
        ...
        >
          <div className="flex items-center gap-2">
            <h3 className="font-medium text-gray-900">{t("status.title")}</h3>
            {openStatus ? (
      ...
      <div>
        ...
        >
          <div className="flex items-center gap-2">
            <h3 className="font-medium text-gray-900">{t("category.title")}</h3>
            {openCategory ? (
              <ChevronUpIcon className="w-5 h-5 text-gray-500" />
            ) : (
              <ChevronDownIcon className="w-5 h-5 text-gray-500" />
      ...
      <div>
        ...
        >
          <div className="flex items-center gap-2">
            <h3 className="font-medium text-gray-900">{t("price.title")}</h3>
            {openPrice ? (
              <ChevronUpIcon className="w-5 h-5 text-gray-500" />
            ) : (
              <ChevronDownIcon className="w-5 h-5 text-gray-500" />
