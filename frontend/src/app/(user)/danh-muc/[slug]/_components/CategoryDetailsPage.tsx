    ...
    if (!category) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh]">
                <div className="text-2xl font-bold text-red-500 mb-4">Không tìm thấy danh mục</div>
                <CustomLink
        ...
        <div className="container mx-auto px-4 py-8">
            ...
            >
                ...
                <div className="flex-1 flex flex-col justify-center">
                    <h1 className="text-2xl md:text-3xl font-bold mb-4 text-orange-600">{category.name}</h1>
