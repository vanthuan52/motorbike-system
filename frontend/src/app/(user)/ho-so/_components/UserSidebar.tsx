...
const customerSidebarItems = [
  ...
  { label: "Lịch sử bảo mật", icon: HistoryOutlined, href: "/lich-su-bao-duong" },
  {
    label: "Cài đặt & Chinh sách bảo mật",
    icon: SettingOutlined,
    children: [
      { label: "Tài khoản", href: "/tai-khoan", icon: IdcardOutlined },
      { label: "Chinh sách bảo mật", href: "/chinh-sach-bao-mat", icon: LockOutlined },
    ],
  },
...
export default function UserSidebar() {
  ...
  return (
    <aside
      className={clsx(
        "lg:flex fixed top-0 left-6 bg-white rounded-br-xl shadow p-6 flex-col w-85 z-50 transform transition-transform duration-300 hidden",
