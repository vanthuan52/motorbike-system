...
This document covers the aution functionality, including activity and password history tracking.
...
The Activity module provides comprehensive user activity tracking throughout the application. It records actions performed by users with detailed information about what was done, when it occured, and who initiated the action.

### How to Use

The Activity module is designed to be used accross the application to track important user actions. There are twi main methods for creating activities:
...
- Differentiates between different type of password changes (`SIGN_UP`, `FORGOT`, `TEMPORARY`, `CHANGE`)
- Supports quering password history for policy enforcement
- Implements configurable password expirations periods
