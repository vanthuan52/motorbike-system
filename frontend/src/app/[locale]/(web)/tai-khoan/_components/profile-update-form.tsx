      ...
      >
        <div>
          <label className="block mb-1 font-medium text-text-secondary">
            <span className="text-error">*</span> Họ và tên
          </label>
          <input
            type="text"
            defaultValue={user?.name ?? ""}
            className="w-full border border-border-strong rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary-500"
            required
            name="first_name"
          />
        </div>
        ...
        <div>
          <label className="block mb-1 font-medium text-text-secondary">
            <span className="text-error">*</span> Số điện thoại
          </label>
          <input
            type="tel"
        ...
        <div>
          <label className="block mb-1 font-medium text-text-secondary">
            <span className="text-error">*</span> Giới tính
          </label>
          <select
        ...
        <div>
          <label className="block mb-1 font-medium text-text-secondary">
            <span className="text-error">*</span> Ngày sinh
          </label>
          <input
            type="date"
        ...
        <div>
          <label className="block mb-1 font-medium text-text-secondary">
            <span className="text-error">*</span> Thành phố
          </label>
          <select
        ...
        <div>
          <label className="block mb-1 font-medium text-text-secondary">
            <span className="text-error">*</span> Quận/Huyện
          </label>
          <select
        ...
        <div>
          <label className="block mb-1 font-medium text-text-secondary">
            <span className="text-error">*</span> Phường/Xã
          </label>
          <select
            value={selectedWard}
        ...
        <div className="sm:col-span-2">
          <label className="block mb-1 font-medium text-text-secondary">
            <span className="text-error">*</span> Địa chỉ cụ thể
          </label>
          <input
            type="text"
        ...
        <div className="sm:col-span-2 text-right">
          <button
            type="submit"
            className="px-6 py-2 rounded bg-primary-500 text-white font-semibold hover:bg-primary-600 transition"
          >
            Cập nhật
          </button>
        </div>
