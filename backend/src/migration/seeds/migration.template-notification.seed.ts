  ...
  implements IMigrationSeed
{
  ...
  async seed(): Promise<void> {
    ...
    if (!changePasswordEmail) {
      this.logger.log('Change Password Email template missing, importing...');
      promises.push(
    ...
    if (!welcomeSocialEmail) {
      this.logger.log('Welcome Social Email template missing, importing...');
      promises.push(
    ...
    if (!welcomeByAdminEmail) {
      this.logger.log('Welcome By Admin Email template missing, importing...');
      promises.push(
    ...
    if (!emailVerifiedEmail) {
      this.logger.log('Email Verified Email template missing, importing...');
      promises.push(
    ...
    if (!forgotPasswordEmail) {
      this.logger.log('Forgot Password Email template missing, importing...');
      promises.push(
    ...
    if (!verificationEmail) {
      this.logger.log('Verification Email template missing, importing...');
      promises.push(
    ...
    if (!welcomeEmail) {
      ...
      promises.push(this.notificationEmailTemplateService.emailImportWelcome());
    }
    ...
    if (!newDeviceLoginEmail) {
      this.logger.log('New Device Login Email template missing, importing...');
      promises.push(
    ...
    if (!resetPasswordEmail) {
      this.logger.log('Reset Password Email template missing, importing...');
      promises.push(
