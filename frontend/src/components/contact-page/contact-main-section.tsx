  ...
  return (
    <section className="relative bg-white overflow-hidden">
      <div className="relative h-[500px] lg:h-[600px]">
        {/* Background Image */}
        <Image
          src="/images/contact/contact-hero-section-image-.jpg"
        ...
        {/* Content */}
        <div className="absolute z-20 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center px-4 w-full">
          <h1 className="text-4xl lg:text-5xl font-bold mb-4 text-white">
            Liên hệ
          </h1>
          <p className="text-lg lg:text-xl max-w-2xl mx-auto text-white">
            Chúng tôi luôn sẵn sàng cung cấp hỗ trợ và giải đáp mọi thắc mắc của
            bạn.
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 bg-white shadow-lg rounded-2xl overflow-hidden">
          <div className="p-8 md:p-12 bg-gray-50">
            ...
            <p className="text-gray-600 mb-8">
              Chúng tôi rất vui khi nhận được phản hồi từ bạn. Nếu bạn có bất kỳ
              câu hỏi nào về sản phẩm hoặc dịch vụ của chúng tôi, hãy liên hệ
              với chúng tôi qua thông tin bên dưới hoặc điền vào biểu mẫu liên
              hệ.
            </p>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="font-semibold text-gray-800">Trụ sở chính</h3>
