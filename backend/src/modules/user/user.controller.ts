...
import { RestResponse } from '@/common/helper/rest-response.helper';
...
export class UserController {
  ...
  async getUsersWithPagination(@Query() query: QueryUserDto) {
    ...
    return RestResponse.success('Users retrieved successfully', []);
  }
  ...
  async getUserById(@Param('id') id: string) {
    ...
    return RestResponse.success('User retrieved successfully', {
      user: plainToInstance(UserResponseDto, user),
    });
  }
