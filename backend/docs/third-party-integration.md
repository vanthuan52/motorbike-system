...
The project integrates with various third-party services to provide a complete application framework. This document outlines these integrations and how they are configured in the application
...
- **Purpose**: File storage with seperate pulbic and private buckets
...
- **Environment Variables**: `DATABASE_URI`, `DATABASE_DEBUG`
...
- **Features**:
  ...
  - Seperate configuration for caching and queue instances
...
- **Implementation**: Uses ES512 algorithm with seperate key pairs for access and refrsh tokens
