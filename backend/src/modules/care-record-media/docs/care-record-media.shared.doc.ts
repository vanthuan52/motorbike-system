...
export function CareRecordMediaSharedListDoc(): MethodDecorator {
...
export function CareRecordMediaSharedCreateDoc(): MethodDecorator {
  return applyDecorators(
    Doc({
...
export function CareRecordMediaSharedUpdateDoc(): MethodDecorator {
  return applyDecorators(
    Doc({
...
export function CareRecordMediaSharedDeleteDoc(): MethodDecorator {
  return applyDecorators(
    Doc({
...
export function CareRecordMediaSharedParamsIdDoc(): MethodDecorator {
  return applyDecorators(
    Doc({
...
export function CareRecordMediaSharedGetDoc(): MethodDecorator {
  return applyDecorators(
    Doc({
