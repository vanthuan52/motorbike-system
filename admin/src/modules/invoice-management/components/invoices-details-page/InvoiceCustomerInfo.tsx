...
export default function InvoiceCustomerInfo({ customer, invoice }: { customer: CustomerType, invoice: InvoiceManagement }) {
    return (
        <div className="bg-gray-100 rounded-xl p-4 sm:p-6 w-full lg:w-[350px] max-w-full lg:max-w-[400px] mt-4 lg:mt-0">
            ...
            <div className="flex gap-4 items-center pt-4 flex-wrap">
                <img src={customer?.photo || ""} alt={customer?.first_name || ""} className="w-16 h-16 sm:w-20 sm:h-20 object-cover rounded-[20px]" />
                <div>
            ...
            <div className="flex gap-2 items-center">
                ...
                <span className="font-semibold text-base sm:text-lg text-gray-400 break-all">{customer?.email}</span>
            </div>
            <Divider />
            <div className="pt-4">
