    ...
    >
      ...
      >
        ...
        >
          <div className="flex-1">
            <div className="flex justify-between items-center">
              <span className="font-semibold">{t("free.title")}</span>
              <span className="ml-1 font-semibold">0 vnđ</span>
            </div>
            <p className="text-sm text-gray-500 mt-1">{t("free.time")}</p>
          </div>
        </Radio>
        <Radio
          value="express"
        ...
        >
          <div className="flex-1">
            <div className="flex justify-between items-center">
              <span className="font-semibold">{t("express.title")}</span>
              <span className="ml-1 font-semibold">45000 vnđ</span>
            </div>
            <p className="text-sm text-gray-500 mt-1">{t("express.time")}</p>
          </div>
        </Radio>
      </Radio.Group>
    </ConfigProvider>
