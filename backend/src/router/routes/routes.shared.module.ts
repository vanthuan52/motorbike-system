...
import { CareRecordServiceSharedController } from '@/modules/care-record-service/controllers/care-record-service.shared.controller';
...
@Module({
  controllers: [
    ...
    CareRecordServiceSharedController,
  ],
  providers: [],
  exports: [],
  imports: [
