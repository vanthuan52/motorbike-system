...
@Module({
  imports: [],
  controllers: [],
  providers: [ServiceCategoryService, ServiceCategoryRepository, ServiceCategoryUtil],
  exports: [ServiceCategoryService, ServiceCategoryRepository, ServiceCategoryUtil],
})
