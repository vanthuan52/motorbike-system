...
export class NotificationEmailUtil {
  ...
  async sendWelcomeByAdmin(
    ...
    await this.emailQueue.add(EnumNotificationProcess.welcomeByAdmin, payload, {
  ...
  async sendResetPassword({
    ...
    await this.emailQueue.add(EnumNotificationProcess.resetPassword, payload, {
  ...
  async sendChangePassword({
    ...
    await this.emailQueue.add(EnumNotificationProcess.changePassword, payload, {
      priority: EnumQueuePriority.low,
      deduplication: {
  ...
  async sendWelcomeSocial({
    ...
    await this.emailQueue.add(EnumNotificationProcess.welcomeSocial, payload, {
  ...
  async sendVerifiedEmail(
    ...
    await this.emailQueue.add(EnumNotificationProcess.verifiedEmail, payload, {
  ...
  async sendForgotPassword(
    ...
    await this.emailQueue.add(EnumNotificationProcess.forgotPassword, payload, {
      deduplication: {
  ...
  async sendNewDeviceLogin(
    ...
    await this.emailQueue.add(EnumNotificationProcess.newDeviceLogin, payload, {
      deduplication: {
