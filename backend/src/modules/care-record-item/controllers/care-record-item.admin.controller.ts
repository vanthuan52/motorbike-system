...
import {
  CareRecordItemAdminCreateDoc,
  CareRecordItemAdminDeleteDoc,
  CareRecordItemAdminListDoc,
  CareRecordItemAdminParamsIdDoc,
  CareRecordItemAdminUpdateDoc,
  CareRecordItemAdminUpdateApprovalDoc,
...
export class CareRecordItemAdminController {
  private readonly logger = new Logger(CareRecordItemAdminController.name);
  constructor(
