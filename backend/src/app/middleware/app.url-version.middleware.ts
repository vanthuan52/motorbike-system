...
export class AppUrlVersionMiddleware implements NestMiddleware {
  private readonly logger = new Logger(AppUrlVersionMiddleware.name);
  ...
  constructor(private readonly configService: ConfigService) {
    ...
    this.urlVersion = this.configService.get<string>('app.versioning.version')!;
  }

  async use(req: IRequestApp, _res: Response, next: NextFunction) {
